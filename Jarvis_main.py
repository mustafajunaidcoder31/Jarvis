        ...
        if "wake up" in query:
            ...
            while True:
                ...
                ############################################################
                    ...
                    b = random.choice(a)
                    if b==1:
                        webbrowser.open("youtube.com/watch?v=QtxeJ703w18")
                    ...
                    from NewsRead import speak_news
                    speak_news()
                   ...
                   print(f"current {searchdate} is {date}")
                    ...
                    speak("ok sir shutting dwon system")
                    os.system("shutdown /s /t 1")

                elif "type" in query:
                    type = query.replace("type","")
                    type = query.replace("jarvis","")
                    pyautogui.typewrite(query)
